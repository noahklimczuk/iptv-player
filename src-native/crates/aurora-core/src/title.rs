...
const RELEASE_TAGS: &[&str] = &[
    "2160p", "1080p", "1080i", "720p", "576p", "480p", "360p", "4k", "8k", "uhd", "fhd", "hd",
    "sd", "hq", "web-dl", "webdl", "webrip", "web", "bluray", "blu-ray", "brrip", "bdrip",
    "dvdrip", "dvdscr", "hdtv", "hdrip", "cam", "ts", "tc", "remux", "x264", "x265", "h264",
    "h265", "hevc", "avc", "xvid", "divx", "aac", "ac3", "eac3", "dts", "dd5", "dd51", "ddp",
    "truehd", "atmos", "flac", "mp3", "10bit", "8bit", "hdr", "hdr10", "dovi", "dv", "sdr",
    "multi", "dual", "dubbed", "subbed", "vostfr", "vf", "vo", "vff", "subs", "sub", "extended",
    "unrated", "proper", "repack", "internal", "limited", "imax", "remastered", "directors",
    "cut", "uncut", "3d", "sbs", "hsbs",
];
...
fn re_country_prefix() -> &'static Regex {
    ...
    R.get_or_init(|| {
        Regex::new(
            r"^\s*(?:[\(\[]([A-Za-z]{2,4})[\)\]]|([A-Za-z]{2,4})\s*[:|\-\u{2013}])\s*",
        )
        .unwrap()
    })
}
