...
| | |
|---|---|
| Core domain logic (parsers, matching, rules, skip markers, parental, DVR scheduling) | ✅ built, 157 tests |
| Persistence (SQLite, migrations, FTS5 search, profiles, recordings) | ✅ built, 120 tests |
| Ingestion (HTTP, Xtream, M3U, XMLTV, credentials, refresh, recorder) | ✅ built, 81 tests |
...
| React UI (home, guide, live, browse, player, search, settings, recordings, first-run wizard) | ✅ built, 39 E2E journeys |
| Skip Intro/Recap/Credits + Next Episode + Up Next autoplay | ✅ built and tested |
| Tauri host + DVR scheduler | ✅ compiles and tests on Linux with GTK dev packages, 18 tests |
...
| Timeshift, catch-up playback, TMDB artwork | ❌ not started |
